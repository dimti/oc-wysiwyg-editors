...
(function () {
    ...
    window.CKEDITOR || (window.CKEDITOR = function () {
        var a = /(^|.*[\\\/])ckeditor\.js(?:\?.*|;.*)?$/i, f = {
            ...
            status: "unloaded",
            basePath: function () {
                var e = window.CKEDITOR_BASEPATH || "/plugins/anandpatel/wysiwygeditors/formwidgets/editor/assets/ckeditor/";
            ...
            getUrl: function (a) {
                ...
                this.timestamp && ("/" != a.charAt(a.length - 1) && !/[&?]t=/.test(a)) && (a += (0 <= a.indexOf("?") ? "&" : "?") + "t=222" + this.timestamp);
                return a
            },
            domReady: function () {
                function a() {
